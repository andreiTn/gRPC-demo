...
func (*Req) Descriptor() ([]byte, []int) {
	return fileDescriptor_clsrv_8fecd70882989fc6, []int{0}
}
...
func (*Res) Descriptor() ([]byte, []int) {
	return fileDescriptor_clsrv_8fecd70882989fc6, []int{1}
}
...
func (x *streamServiceStreamClient) Send(m *Req) error {
	return x.ClientStream.SendMsg(m)
}

func (x *streamServiceStreamClient) CloseAndRecv() (*Res, error) {
...
func (x *streamServiceStreamServer) SendAndClose(m *Res) error {
	return x.ServerStream.SendMsg(m)
}

func (x *streamServiceStreamServer) Recv() (*Req, error) {
	m := new(Req)
...
var _StreamService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "pb/clsrv.proto",
}

func init() { proto.RegisterFile("pb/clsrv.proto", fileDescriptor_clsrv_8fecd70882989fc6) }

var fileDescriptor_clsrv_8fecd70882989fc6 = []byte{
	// 109 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0xe2, 0x2b, 0x48, 0xd2, 0x4f,
	0xce, 0x29, 0x2e, 0x2a, 0xd3, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x57, 0x12, 0xe7, 0x62, 0x0e, 0x4a,
	0x2d, 0x14, 0x12, 0xe0, 0x62, 0xce, 0x2d, 0x4e, 0x97, 0x60, 0x54, 0x60, 0xd4, 0xe0, 0x0c, 0x02,
	0x31, 0x21, 0x12, 0xc5, 0x98, 0x12, 0x46, 0x9a, 0x5c, 0xbc, 0xc1, 0x25, 0x45, 0xa9, 0x89, 0xb9,
	0xc1, 0xa9, 0x45, 0x65, 0x99, 0xc9, 0xa9, 0x42, 0x12, 0x5c, 0x6c, 0x10, 0x01, 0x21, 0x16, 0xbd,
	0xa0, 0xd4, 0x42, 0x29, 0x10, 0x59, 0xac, 0xc4, 0xa0, 0xc1, 0x98, 0xc4, 0x06, 0xb6, 0xc3, 0x18,
	0x10, 0x00, 0x00, 0xff, 0xff, 0x9c, 0xe9, 0xc6, 0x6a, 0x75, 0x00, 0x00, 0x00,
}
